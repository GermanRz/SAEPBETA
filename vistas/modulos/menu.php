...
<a href="inicio" class="brand-link" style="display: flex; align-items: center; gap: 20px;">
  <img src="vistas/img/logo-sena-blanco.png"
       alt="Logo Sena"
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="index.php?ruta=inicio" class="nav-link">
              <img src="vistas/img/ico-inicio.png" alt="AdminLTE Logo">
              <p>
                Inicio
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <img src="vistas/img/ico-ojo.png" alt="Icono Ver Usuarios">
              <p>
                Ver usuarios
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <img src="vistas/img/ico-usuario.png" alt="Icono Usuarios">
              <p>
                Usuarios
                <i class="right fas fa-angle-left"></i>
              </p>
          ...
          <li class="nav-item">
            <a href="empresa" class="nav-link">
              <img src="vistas/img/ico-empresa.png" alt="Icono Empresas">
              <p>Empresas</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="asignacion" class="nav-link">
              <img src="vistas/img/ico-asignar.png" alt="Icono Asignar">
              <p>Asignar Evaluador</p>
            </a>
          </li>
