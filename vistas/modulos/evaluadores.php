  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-12">
          <button class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#modalAgregarEvaluador">
            Agregar Evaluador
          </button>
        </div>
              ...
              <tbody>
                ...
                if (!empty($evaluadores)) {
                  foreach ($evaluadores as $value) {
                    ...
                    // Botón editar
                    echo '<td><button class="btn btn-xs btn-primary btnEditarEvaluador" idUsuario="' . $value["ID_usuarios"] . '" data-toggle="modal" data-target="#modalEditarEvaluador"><i class="fas fa-pencil-alt"></i></button></td>';
                    echo '</tr>';
                  }
                } else {
                  echo '<tr><td colspan="13">No se encontraron evaluadores registrados.</td></tr>';
                }
                ?>
              </tbody>
            </table>
